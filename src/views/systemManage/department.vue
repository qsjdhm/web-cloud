    ...
    <vt-page type="one">
        <div class="user-page">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                            <span class="set-dot">{{ node.data.name }}</span>
                        </span>
                    </el-tree>
                </div>
            </div>
            <div class="right-pack">
                <div class="department-pack">
                    <bs-table
                        ref="BsTable"
                        :bs-data="bsData"
                    ...
                    >
                        <template #operateHeader>
                            <el-button
                                v-has="{role: 'addDepartment'}"
                                type="primary"
                                size="mini"
                                icon="el-icon-plus"
                                @click="addSubDepartmentClick"
                            >添加子部门
                            </el-button>
                        </template>
                        <template #roles="{scope}">
                            <div>
                                <span v-if="!scope.row.roles || scope.row.roles.length === 0">暂无</span>
                                <span
                        ...
                        <template #operate="{scope}">
                            <el-button
                                v-has="{role: 'editDepartment'}"
                                type="text"
                                @click="editDepartmentClick(scope.row)"
                            >编辑
                            </el-button>
                            <el-button
                                v-has="{role: 'deleteDepartment'}"
                                class="red-text"
                                type="text"
                                @click="deleteDepartmentClick(scope.row)"
                            >删除
                            </el-button>
                        </template>
                    </bs-table>
            ...
            <el-dialog
                ...
                width="530px"
            >
                <div class="edit-department-pack">
                    <el-form
                        ref="editDepartmentFormDom"
                        :model="editDepartmentFormData"
                    ...
                    >
                        <el-row>
                            <el-col>
                                ...
                                >
                                    <el-input
                                        v-model="editDepartmentFormData.code"
                                        type="text"
                                        size="medium"
                        ...
                        <el-row>
                            <el-col>
                                ...
                                >
                                    <el-input
                                        v-model.trim="editDepartmentFormData.name"
                                        type="text"
                                        size="medium"
                                        :maxlength="$global.string"
                                        auto-complete="off"
                        ...
                        <el-row>
                            <el-col>
                                ...
                                >
                                    <el-select
                                        v-model="editDepartmentFormData.roles"
                                        style="width: 100%"
                                        size="medium"
                                        multiple
                                        placeholder="请选择"
                ...
                >
                    <el-button
                        size="mini"
                        @click="cancelEditDepartmentClick"
                    >取 消</el-button>
                    <el-button
                        type="primary"
                        size="mini"
                        @click="saveEditDepartmentClick"
                    >确 定</el-button>
                </span>
            </el-dialog>
            <!-- 添加部门弹框 -->
            <el-dialog
                ...
                width="520px"
            >
                <div class="new-department-pack">
                    <el-form
                        ref="addDepartmentFormDom"
                        :model="addDepartmentFormData"
                        :rules="departmentFormRules"
                        status-icon
                        label-position="right"
                        label-width="100px"
                    >
                        <el-row>
                            <el-col>
                                ...
                                >
                                    <el-input
                                        v-model.trim="addDepartmentFormData.code"
                                        size="medium"
                                        type="text"
                                        maxlength="20"
                                        auto-complete="off"
                        ...
                        >
                            <el-input
                                v-model.trim="addDepartmentFormData.name"
                                size="medium"
                                type="text"
                                maxlength="20"
                                auto-complete="off"
                        ...
                        >
                            <el-select
                                v-model="addDepartmentFormData.roles"
                                size="medium"
                                style="width: 360px;"
                                multiple
                                placeholder="请选择"
                ...
                >
                    <el-button
                        size="mini"
                        @click="cancelAddDepartmentClick"
                    >取 消</el-button>
                    <el-button
                        type="primary"
                        size="mini"
                        @click="saveAddDepartmentClick"
                    >确 定</el-button>
                </span>
            </el-dialog>
            <!-- 选择部门弹框 -->
            ...
            bsData: {
                tableConfig: {
                    ...
                    columns: [
                        ...
                        { label: '操作', slotName: 'operate', width: this.$global.op_2,align: 'center'}
                    ]
                }
            }
        }
